...
//    ====================TESTS WITH DISCOUNT ============================================================================
    ...
    public void calculateFareCarWithMoreThanADayParkingTimeWithDiscount() {
        ...
        fareCalculatorService.calculateFare(ticket);
        assertEquals((24 * Fare.CAR_RATE_PER_HOUR * Fare.DISCOUNT_FOR_REGULAR_USER), ticket.getPrice());
    }
    @Test
    public void calculateFareBikeWithMoreThanADayParkingTimeWithDiscount() {
        ...
        fareCalculatorService.calculateFare(ticket);
        assertEquals((24 * Fare.BIKE_RATE_PER_HOUR * Fare.DISCOUNT_FOR_REGULAR_USER), ticket.getPrice());
    }
